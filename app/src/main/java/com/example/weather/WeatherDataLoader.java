...
class WeatherDataLoader {
    ...
    private static final String OPEN_WEATHER_API_URL_COORDINATE =
    ...
    static JSONObject getJSONDataFromCoordinate(String lat,String lon) {
        try {
            URL url = new URL(String.format(OPEN_WEATHER_API_URL_COORDINATE, lat,lon));
            HttpURLConnection connection = (HttpURLConnection) url.openConnection();
            connection.addRequestProperty(KEY, OPEN_WEATHER_API_KEY);
